...
export function M156ContainerDetailPage() {
  const { id = "" } = useParams(); const [tab, setTab] = useState<Tab>("overview"); const [commitOpen, setCommitOpen] = useState(false);
