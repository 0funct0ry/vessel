...
export function flagState(state: string): "running" | "paused" | "exited" | "stopped" | "created" { if (state === "running" || state === "paused" || state === "created") return state; return state === "exited" ? "exited" : "stopped"; }
...
export function canStop(container: Container): boolean { return container.state === "running" || container.state === "paused"; }
