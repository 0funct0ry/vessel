...
func NewRouter(cfg Config) *gin.Engine {
	...
	v1.DELETE("/events", s.handleEventsClear)
	v1.DELETE("/events/:id", s.handleEventDelete)
	...
	v1.GET("/stacks/:name/logs", s.handleStackLogs)
	v1.POST("/stacks/:name/up", s.handleStackUp)
	v1.POST("/stacks/:name/down", s.handleStackDown)
	v1.POST("/stacks/:name/redeploy", s.handleStackRedeploy)
