...
var protectedRoutes = []protectedRoute{
	...
	{http.MethodGet, "/api/v1/webhooks", "", store.RoleAdmin},
	{http.MethodPost, "/api/v1/webhooks", `{"name":"acme","url":"https://example.com/hook","event_types":["container.start"]}`, store.RoleAdmin},
	{http.MethodGet, "/api/v1/webhooks/w1", "", store.RoleAdmin},
	{http.MethodPatch, "/api/v1/webhooks/w1", `{"enabled":false}`, store.RoleAdmin},
	{http.MethodDelete, "/api/v1/webhooks/w1", "", store.RoleAdmin},
	{http.MethodPost, "/api/v1/webhooks/w1/test", "", store.RoleAdmin},
	{http.MethodGet, "/api/v1/webhooks/w1/deliveries", "", store.RoleAdmin},
	{http.MethodPost, "/api/v1/deliveries/d1/redeliver", "", store.RoleAdmin},
