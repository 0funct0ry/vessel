...
var Policies = []Policy{
	...
	{http.MethodGet, "/api/v1/host/next-port", store.RoleViewer, "host.next_port", true},
	{http.MethodGet, "/api/v1/events", store.RoleViewer, "events.read", true},
	{http.MethodDelete, "/api/v1/events", store.RoleAdmin, "events.clear", true},
	{http.MethodDelete, "/api/v1/events/:id", store.RoleAdmin, "events.delete", true},
	...
	{http.MethodPost, "/api/v1/containers/:id/recreate", store.RoleOperator, "containers.recreate", true},
	...
	{http.MethodGet, "/api/v1/images/:id/dockerfile", store.RoleViewer, "images.dockerfile", true},
	...
	{http.MethodGet, "/api/v1/volumes/:name/files", store.RoleOperator, "volumes.files.list", true},
	{http.MethodPost, "/api/v1/volumes/:name/files", store.RoleOperator, "volumes.files.upload", true},
	{http.MethodPost, "/api/v1/volumes/:name/folders", store.RoleOperator, "volumes.files.mkdir", true},
	{http.MethodGet, "/api/v1/volumes/:name/files/download", store.RoleOperator, "volumes.files.download", true},
	{http.MethodDelete, "/api/v1/volumes/:name/files", store.RoleOperator, "volumes.files.delete", true},
	{http.MethodPost, "/api/v1/volumes/:name/files/rename", store.RoleOperator, "volumes.files.rename", true},
	{http.MethodGet, "/api/v1/volumes/:name/files/view", store.RoleOperator, "volumes.files.view", true},
	{http.MethodPut, "/api/v1/volumes/:name/files/content", store.RoleOperator, "volumes.files.edit", true},
	{http.MethodGet, "/api/v1/volumes/:name/export", store.RoleViewer, "volumes.export", true},
	{http.MethodPost, "/api/v1/volumes/:name/clone", store.RoleOperator, "volumes.clone", true},
	...
	{http.MethodGet, "/api/v1/stacks", store.RoleViewer, "stacks.read", true},
	{http.MethodPost, "/api/v1/stacks", store.RoleOperator, "stacks.create", true},
	{http.MethodGet, "/api/v1/stacks/:name", store.RoleViewer, "stacks.read", true},
	{http.MethodPut, "/api/v1/stacks/:name", store.RoleOperator, "stacks.update", true},
	{http.MethodDelete, "/api/v1/stacks/:name", store.RoleOperator, "stacks.remove", true},
	{http.MethodGet, "/api/v1/stacks/:name/logs", store.RoleViewer, "stacks.logs", true},
	{http.MethodPost, "/api/v1/stacks/:name/up", store.RoleOperator, "stacks.up", true},
	{http.MethodPost, "/api/v1/stacks/:name/down", store.RoleOperator, "stacks.down", true},
	{http.MethodPost, "/api/v1/stacks/:name/redeploy", store.RoleOperator, "stacks.redeploy", true},
	{http.MethodPost, "/api/v1/prune/:kind", store.RoleAdmin, "prune.run", true},
	{http.MethodGet, "/api/v1/webhooks", store.RoleAdmin, "webhooks.read", true},
	{http.MethodPost, "/api/v1/webhooks", store.RoleAdmin, "webhooks.create", true},
	{http.MethodGet, "/api/v1/webhooks/:id", store.RoleAdmin, "webhooks.read", true},
	{http.MethodPatch, "/api/v1/webhooks/:id", store.RoleAdmin, "webhooks.update", true},
	{http.MethodDelete, "/api/v1/webhooks/:id", store.RoleAdmin, "webhooks.remove", true},
	{http.MethodPost, "/api/v1/webhooks/:id/test", store.RoleAdmin, "webhooks.test", true},
	{http.MethodGet, "/api/v1/webhooks/:id/deliveries", store.RoleAdmin, "webhooks.deliveries", true},
	{http.MethodPost, "/api/v1/deliveries/:id/redeliver", store.RoleAdmin, "deliveries.redeliver", true},
