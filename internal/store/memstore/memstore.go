...
func New() *Store {
	return &Store{settings: map[string]string{}, users: map[int64]store.User{}, usernames: map[string]int64{}, webhooks: map[string]store.Webhook{}, deliveries: map[string]store.Delivery{}, byWebhook: map[string][]string{}, nextUserID: 1}
}
